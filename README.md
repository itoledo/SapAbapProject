...
- Allows importing source code from an existing SAP ABAP system into a project. It creates an .abap file for each source object (tables, functions, etc.) in the project.
- Syntax coloring.
